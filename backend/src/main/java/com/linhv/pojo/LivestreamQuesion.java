...
@NamedQueries({
    ...
    @NamedQuery(name = "LivestreamQuesion.findByAdmissionType", query = "SELECT l FROM LivestreamQuesion l WHERE l.admissionType = :admissionType")})
public class LivestreamQuesion implements Serializable {
    ...
    public LivestreamQuesion(String id, String content, String admissionType) {
        this.id = id;
