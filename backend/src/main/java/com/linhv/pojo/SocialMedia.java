...
@NamedQueries({
    ...
    @NamedQuery(name = "SocialMedia.findById", query = "SELECT s FROM SocialMedia s WHERE s.id = :id"),
...
public class SocialMedia implements Serializable {
    ...
    public SocialMedia(Integer id) {
        this.id = id;
    }

    public SocialMedia(Integer id, String name, String link) {
        this.id = id;
        this.name = name;
        this.link = link;
    }
    ...
    public String toString() {
        return "com.linhv.pojo.SocialMedia[ id=" + id + " ]";
    }
